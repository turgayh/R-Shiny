...
```
# <span style="font-weight:bold">  Chapter 1 </span> <br> </br> Motivation, Basic R-Shiny Package and Example {data-background=#ffff00 .center}
...
```
# <span style="font-weight:bold">  Chapter 2</span> <br> </br> Structure of a Shiny App {data-background=#ff33cc .center}
## Main Structure
<div class="row">
...
# <span style="font-weight:bold">  Chapter 3</span> <br> </br> Inputs and Outputs {data-background=#ff3300 .center}
## Overview
...
# <span style="font-weight:bold">  Chapter 4</span> <br> </br> Using Checkbox in Shiny {data-background=#00ccff .center}
...
<br></br>In R, <span style="color:purple; font-weight:bold">HTML elements</span> can be defined by <span style="color:green; font-weight:bold">tags</span> keyword.
