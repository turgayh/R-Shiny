...
At first, we have to define user interface and title
```r
library(shiny)
...
Secondly, we define the sidebar panel inputs and checkbox
```r
...
## Using Checkbox in Shiny 
 ...
 Then, we define the main panel for displaying outputs
...
After that, we define the server logic to summarize and view selected dataset
...
At last, we show the first "n" observations and create the shiny app
```r
